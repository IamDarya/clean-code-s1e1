...
var incompleteTaskHolder=document.querySelector(".block-incomplete-tasks");//ul of #block-incomplete-tasks
var completedTasksHolder=document.querySelector(".block-completed-tasks");//completed-tasks
